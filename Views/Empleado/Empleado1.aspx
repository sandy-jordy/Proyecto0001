<%@ Page Title="Empleado" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Empleado1.aspx.cs" Inherits="SIS_CA.Empleado1" %>
        ...
        <tr>
            <td colspan="10">
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="id_empleado" Height="75px" Width="721px" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        <Columns>
                            <asp:ButtonField ButtonType="Button" CausesValidation="True" InsertVisible="False" Text="eliminar" />
                        </Columns>
