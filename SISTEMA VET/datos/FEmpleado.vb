...
Public Class FEmpleado
    ...
    Public Function mostrar_empleado() As DataTable
        Try
            conectado()
            cmd = New SqlCommand("SP_mostrar_empleado")
    ...
    Public Function mostrar_empleado_activo() As DataTable
        Try
            conectado()
            cmd = New SqlCommand("SP_mostrar_empleados_Activos")
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Connection = cnn
            If cmd.ExecuteNonQuery Then
                Dim dt As New DataTable
        ...
        End Try
    End Function
    Public Function insertar_empleado(ByVal dts As vEmpleado) As Boolean
        Try
            conectado()
